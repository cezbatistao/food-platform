...
// Source: internal/app/gateway/order_gateway.go
...
func (m *MockOrderGateway) GetByUuid(ctx context.Context, userUuid, orderUuid *uuid.UUID) (*domain.Order, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByUuid", ctx, userUuid, orderUuid)
...
func (mr *MockOrderGatewayMockRecorder) GetByUuid(ctx, userUuid, orderUuid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByUuid", reflect.TypeOf((*MockOrderGateway)(nil).GetByUuid), ctx, userUuid, orderUuid)
}

// ListAllByUserUuid mocks base method.
func (m *MockOrderGateway) ListAllByUserUuid(ctx context.Context, orderPageable *domain.OrderPageable) (*domain.Page, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAllByUserUuid", ctx, orderPageable)
	ret0, _ := ret[0].(*domain.Page)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListAllByUserUuid indicates an expected call of ListAllByUserUuid.
func (mr *MockOrderGatewayMockRecorder) ListAllByUserUuid(ctx, orderPageable interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAllByUserUuid", reflect.TypeOf((*MockOrderGateway)(nil).ListAllByUserUuid), ctx, orderPageable)
}
