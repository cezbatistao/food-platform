...
class MenuItemTemplate: TemplateLoader {

    override fun load() {
        Fixture.of(MenuItem::class.java)
                .addTemplate("pizza hut pepperoni", object : Rule() {
                    init {
                        add("id", 1L)
                        add("uuid", UUID.fromString("743b55f8-9543-11eb-a8b3-0242ac130003"))
                        add("name", "Pepperoni")
                ...
                .addTemplate("pizza hut meat", object : Rule() {
                    init {
                        add("id", 2L)
                        add("uuid", UUID.fromString("773712b0-9543-11eb-a8b3-0242ac130003"))
                        add("name", "Meat")
                ...
                .addTemplate("pizza hut supreme", object : Rule() {
                    init {
                        add("id", 3L)
                        add("uuid", UUID.fromString("7d35de8a-9543-11eb-a8b3-0242ac130003"))
                        add("name", "Supreme")
                ...
                .addTemplate("pizza braz napolitan", object : Rule() {
                    init {
                        add("id", 4L)
                        add("uuid", UUID.fromString("8dc970ae-9543-11eb-a8b3-0242ac130003"))
                        add("name", "NAPOLITANA")
                ...
                .addTemplate("pizza braz pepperoni", object : Rule() {
                    init {
                        add("id", 5L)
                        add("uuid", UUID.fromString("81af3f42-9543-11eb-a8b3-0242ac130003"))
                        add("name", "CALABRESA")
                ...
                .addTemplate("pizza dominos pepperoni", object : Rule() {
                    init {
                        add("id", 6L)
                        add("uuid", UUID.fromString("843bfe62-9543-11eb-a8b3-0242ac130003"))
                        add("name", "Pepperoni")
                ...
                .addTemplate("pizza dominos mozzarella", object : Rule() {
                    init {
                        add("id", 7L)
                        add("uuid", UUID.fromString("88e3812e-9543-11eb-a8b3-0242ac130003"))
                        add("name", "Mussarela")
